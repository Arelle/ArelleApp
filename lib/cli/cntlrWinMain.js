...
function treeGridShowObject(grid, filingId, id, arcrole) {
    urlApiResultsFunction("Selecting relationships", 
                    	  "/select/relationships?id=" + id + "&filingId=" + filingId + "&arcrole=" + arcrole, 
                          function(results){
    	var id = results[0];
...
function dataPointsGridShowObject(grid, filingId, id) {
    urlApiResultsFunction("Selecting data point", 
    					  "/select/datapoints?id=" + id + "&filingId=" + filingId, 
    					  function(results){
        grid.selectRowById(results[0], false, true, false);
    });
}
...
function viewFiling(filingId) {
    ...
    rlStatusbar.setText("Loading filing " + filingId);
    ...
    rlStatusbar.setText("Loading aspects " + filingId);
    ...
    rlStatusbar.setText("Loading linkbases " + filingId);
